...
const PAGES = [
  ...
  { slug: "desarrollo-web", path: "/servicios/desarrollo-web" },
  { slug: "agentes-ia", path: "/servicios/agentes-ia" },
  { slug: "automatizacion", path: "/servicios/automatizacion" },
  { slug: "datos-analitica", path: "/servicios/datos-y-analitica" },
  { slug: "infraestructura", path: "/servicios/infraestructura-digital" },
  { slug: "clinicas", path: "/clinicas" },
  { slug: "legales", path: "/servicios-legales" },
  { slug: "locales", path: "/servicios-locales" },
];
...
async function main() {
  ...
  console.log("Full-site screenshots saved to", OUT);
}
