...
import { MessageCircleMore, AlertTriangle, CalendarCheck, ShieldCheck } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "Tu estudio de abogacía laboral responde el 100% de sus consultas, prioriza los casos urgentes y agenda la primera consulta — configurado en días. Diagnóstico gratis.",
};
        ...
        <Reveal>
          <div className="card-soft-tint text-center">
            ...
            <p className="mt-4 text-ink/65">
              ...
              asistente no te ahorra tiempo ni te ayuda a agendar más
              consultas,{" "}
