...
const ECLIPSE_TERRACOTA = "#D4622B";
const ECLIPSE_DORADO = "#C1892B";
const ECLIPSE_ROJO_TIERRA = "#8C2F1B";
const WORDMARK_FILL = "#f2e8dc";
    ...
    >
      <defs>
        ...
        {!prefersReducedMotion && (
          ...
          >
            <stop offset="0%" stopColor={ECLIPSE_TERRACOTA} />
            <stop offset="50%" stopColor={ECLIPSE_DORADO} />
            <stop offset="100%" stopColor={ECLIPSE_ROJO_TIERRA} />
            <animateTransform
